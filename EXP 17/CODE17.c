...
#define MAX_RESOURCES 3 int is_safe();
...
// Check if system is in safe state after allocation if (is_safe()) {
...
if (j == MAX_RESOURCES) {
// Process can finish, update work and mark as finished for (int k = 0; k < MAX_RESOURCES; k++) {
